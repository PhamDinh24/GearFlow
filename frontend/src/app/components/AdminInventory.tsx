        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center">
            ...
            <HelpTooltip 
              ...
              content="Theo dõi chi tiết số lượng hàng hóa theo từng biến thể (màu sắc, switch, v.v.):
              • Cập nhật nhanh: Click icon bút chì để điều chỉnh số lượng tồn kho cho từng biến thể.
              • Cảnh báo: Các mặt hàng sắp hết (dưới 5 sản phẩm) sẽ được tô màu cam để nhắc nhở nhập hàng.
              • Lọc trạng thái: Xem nhanh các mặt hàng Đã hết, Sắp hết hoặc Còn hàng.
              • Tìm kiếm: Tìm theo tên sản phẩm hoặc đặc tính (Blue switch, Red color, v.v.)."
            />
          </div>
