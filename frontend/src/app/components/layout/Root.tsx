...
import { ShoppingCart, User, Heart, LayoutDashboard, Search, X, LogOut, Package, Settings, ChevronDown, Menu, Keyboard } from "lucide-react";
...
export function Root() {
  ...
  // Load cart count and wishlist count
  useEffect(() => {
