          ...
          <div>
            <div className="flex items-center">
              ...
              <HelpTooltip 
                ...
                content="Trang Dashboard cung cấp cái nhìn tổng quan về tình hình kinh doanh:
                • Doanh thu & Đơn hàng: Các chỉ số tăng trưởng quan trọng.
                • Biểu đồ doanh thu: Theo dõi biến động doanh thu theo thời gian.
                • Sản phẩm & Thương hiệu bán chạy: Biết được đâu là mặt hàng đang hot.
                • Đơn hàng chờ xử lý: Nhắc nhở các đơn hàng cần xác nhận ngay."
              />
            </div>
