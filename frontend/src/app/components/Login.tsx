      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="mt-8 border-t border-slate-100 pt-6">
            <p className="text-xs text-slate-400 text-center mb-3 font-medium uppercase tracking-wider">Tài khoản demo</p>
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                onClick={() => fillDemo('user')}
                className="p-3 border-2 border-slate-200 rounded-xl text-left hover:border-indigo-300 hover:bg-indigo-50 transition-all"
              >
                <div className="text-xs font-semibold text-slate-700 mb-1">👤 Khách hàng</div>
                <div className="text-xs text-slate-500">sampleuser1</div>
                <div className="text-xs text-slate-500">password</div>
              </button>
              <button
                type="button"
                onClick={() => fillDemo('admin')}
                className="p-3 border-2 border-slate-200 rounded-xl text-left hover:border-purple-300 hover:bg-purple-50 transition-all"
              >
                <div className="text-xs font-semibold text-slate-700 mb-1">⚙️ Quản trị viên</div>
                <div className="text-xs text-slate-500">sampleadmin1</div>
                <div className="text-xs text-slate-500">password</div>
              </button>
            </div>
          </div>
