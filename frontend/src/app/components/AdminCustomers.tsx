        ...
        <div className="mb-8">
          <div className="flex items-center">
            ...
            <HelpTooltip 
              ...
              content="Công cụ quản lý người dùng và phân quyền hệ thống:
              • Phân quyền: Cấp quyền Admin cho người dùng tin cậy hoặc thu hồi nếu cần.
              • Khóa tài khoản: Sử dụng icon ổ khóa để tạm dừng hoạt động của tài khoản vi phạm.
              • Xem thông tin: Kiểm tra lịch sử mua hàng, tổng chi tiêu và thông tin liên hệ.
              • Tìm kiếm: Tìm nhanh tài khoản theo Tên, Email hoặc Số điện thoại."
            />
          </div>
