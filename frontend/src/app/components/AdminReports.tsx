          ...
          <div>
            <div className="flex items-center">
              ...
              <HelpTooltip 
                ...
                content="Phân tích dữ liệu kinh doanh đa chiều:
                • Chỉ số quan trọng: Theo dõi Doanh thu, Đơn hàng, Giá trị trung bình và Tỷ lệ hủy.
                • Biểu đồ doanh thu: Chuyển đổi giữa Tháng, Quý, Năm để xem xu hướng dài hạn.
                • Phân bổ Layout: Hiểu rõ khách hàng ưa chuộng loại bàn phím nào (75%, TKL, v.v.).
                • Thanh toán: Thống kê tỷ lệ thanh toán qua VNPAY vs COD.
                • Xuất dữ liệu: Tải báo cáo về máy để phục vụ lưu trữ hoặc in ấn."
              />
            </div>
